...
# all the admin paths
 ...
 #   subject.resource :standards
  ...
  map.resources :unit_planners, :member=>{:update_learning_styles=>:put, :update_lprofiles=>:put, :edit_identification=>:get, :edit_vision=>:get, :edit_objectives=>:get, :update_objectives=>:put, :edit_tasks=>:get, :update_tasks=>:put, :edit_backward_planner=>:get, :update_backward_planner=>:put} do |unit_planner|
